#ifndef FILE_DATE_CITIZEN_COUNTRY_H_INCLUDED
#define FILE_DATE_CITIZEN_COUNTRY_H_INCLUDED
...
struct citizen{
    ...
    citizen(int citizenID, std::string fname, std::string lname, int age,
            country *pcountry);
    bool isTheSame(int citizenID, std::string fname, std::string lname,
                   int age, std::string country_name);/*Returns true if ID,
